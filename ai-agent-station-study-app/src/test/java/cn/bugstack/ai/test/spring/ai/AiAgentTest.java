...
public class AiAgentTest {
    ...
    public void init() {
        ...
        OpenAiApi openAiApi = OpenAiApi.builder()
                ...
                .apiKey("sk-f46923e8751341f4b3147a4300d38aaf")
                .build();
    ...
    public void test_client03() {
        ...
        String content = chatClient01
                ...
                .advisors(a -> a
                        ...
                        .param(CHAT_MEMORY_RETRIEVE_SIZE_KEY, Optional.of(100)))
                .call().content();
...
//                .defaultTools(new SyncMcpToolCallbackProvider(sseMcpClient01(), sseMcpClient02()))
    ...
    public McpSyncClient sseMcpClient01() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://115.190.5.32:8102").build();
    ...
    public McpSyncClient sseMcpClient02() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://115.190.5.32:8101").build();
